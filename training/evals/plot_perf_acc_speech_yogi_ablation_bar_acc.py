...
def main(files):
    ...
    for index,file in enumerate(files):
        ...
        metrics_stat.append(mean(metrics[-1][-20:]))
    ...
    plot_line(metrics_stat, walltime_stat, setting_labels, 'Google speech+ResNet-34', plot_metric, 'time_to_acc_speech_yogi_ablation_bar_acc.pdf')
