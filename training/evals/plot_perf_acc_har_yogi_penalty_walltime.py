...
def main(files):
    ...
    for index,file in enumerate(files):
        ...
        if index==0:
            ...
            metrics[index]=metrics[index][:280]
        metrics[index]=metrics[index][:400]
        metrics[-1] = movingAvg(metrics[-1], 30)
        walltime[-1] = walltime[-1][:len(metrics[-1])]
        epoch[-1] = epoch[-1][:len(metrics[-1])]
        plot_metric = metrics_label[history['task']]
    setting_labels[0]=r'oort ($\alpha$=0)'
    setting_labels[1]=r'oort ($\alpha$=1)'
    setting_labels[2]=r'oort ($\alpha$=2)'
    setting_labels[3]=r'oort ($\alpha$=5)'
    setting_labels[4]=r'ours ($\alpha$=0)'
    setting_labels[5]=r'ours ($\alpha$=1)'
    setting_labels[6]=r'ours ($\alpha$=2)'
    setting_labels[7]=r'ours ($\alpha$=5)'
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_har_yogi_penalty_walltime.png')


# shufflenet
# main(['logs/har/0816_173449_77/aggregator/training_perf',
# 'logs/har/0816_173452_45079/aggregator/training_perf',
# 'logs/har/0818_152318_7911/aggregator/training_perf',
# 'logs/har/0818_151729_7778/aggregator/training_perf',
# 'logs/har/0816_174536_52223/aggregator/training_perf',
# 'logs/har/0818_151808_54558/aggregator/training_perf',
# ])
main(['logs/har/0818_165517_9791/aggregator/training_perf',
'logs/har/0818_165540_45936/aggregator/training_perf',
'logs/har/0816_173452_45079/aggregator/training_perf',
'logs/har/0818_165556_47915/aggregator/training_perf',
'logs/har/0818_152318_7911/aggregator/training_perf',
'logs/har/0818_151729_7778/aggregator/training_perf',
'logs/har/0816_174536_52223/aggregator/training_perf',
'logs/har/0818_151808_54558/aggregator/training_perf',
