...
def main(files):
    ...
    plot_line(metrics, epoch, setting_labels, 'Training Time', plot_metric, 'time_to_acc_openimage_baseline.png')

# main(sys.argv[1:])
# mobilenet
main(['logs/openimage/0803_213929_46443/aggregator/training_perf',
'logs/openimage/0803_214633_39368/aggregator/training_perf',
'logs/openimage/0719_210948_48370/aggregator/training_perf',
'logs/openimage/0719_211249_44960/aggregator/training_perf'])

# shufflenet
# main(['logs/openimage/0804_043443_3235/aggregator/training_perf','logs/openimage/0804_053601_2756/aggregator/training_perf','logs/openimage/0719_113955_1403/aggregator/training_perf','logs/openimage/0719_114250_5117/aggregator/training_perf'])
