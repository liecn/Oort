...
def main(files):
    ...
    for index,file in enumerate(files):
        ...
        metrics[-1] = movingAvg(metrics[-1], 50)
        walltime[-1] = walltime[-1][:len(metrics[-1])]
        epoch[-1] = epoch[-1][:len(metrics[-1])]
        plot_metric = metrics_label[history['task']]
    setting_labels[1]=r'ours (a=0.1,b=0.3)'
    setting_labels[2]=r'ours (a=0.3,b=0.6)'
    setting_labels[3]=r'ours (a=0.1,b=0.6)'
    setting_labels[4]=r'ours (a=0.2,b=0.8)'    
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_har_yogi_ab_walltime.pdf')


# shufflenet
main([
'logs/har/0816_173452_45079/aggregator/training_perf',
'logs/har/0818_180344_21979/aggregator/training_perf',
'logs/har/0818_180321_43080/aggregator/training_perf',
'logs/har/0816_174536_52223/aggregator/training_perf',
'logs/har/0818_180411_48575/aggregator/training_perf',
])
