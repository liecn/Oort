...
date_str_list={'openimage/0805_051031_20089','openimage/0803_213929_46443','openimage/0805_053851_11725','openimage/0803_214633_39368','openimage/0813_110047_7281','openimage/0814_112556_9894'};
for ii=1:1:length(date_str_list)
%     data_root = ['/mnt/home/lichenni/projects/Oort/training/evals/logs/',date_str_list{ii},'/worker/'];
    data_root = ['D:\Oort\training\evals/logs/',date_str_list{ii},'/aggregator/'];

    error_path = [data_root, 'training_perf'];
    fid=py.open(error_path,'rb');
    a=py.pickle.load(fid);
    error_matrix = struct(a);

    client_label = error_matrix.('perf');
