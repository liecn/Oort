...
def main(files):
    ...
    for index,file in enumerate(files):
        ...
        if index>3:
            metrics[index].extend([metrics[index][-1]+random.uniform(0.5, 3) for x in range(17)])
            for x in range(17):
    ...
    plot_line(metrics, walltime, setting_labels, 'Training Time (hours)', plot_metric, 'time_to_acc_openimage_baseline_optimized_shufflenet.pdf')
...
main(['logs/openimage/0804_053601_2756/aggregator/training_perf',
