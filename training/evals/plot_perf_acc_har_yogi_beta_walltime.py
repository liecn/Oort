...
def main(files):
    ...
    setting_labels[1]=r'ours ($\beta$=0.1)'
    setting_labels[2]=r'ours ($\beta$=0.3)'
    setting_labels[3]=r'ours ($\beta$=0.7)'
    setting_labels[4]=r'ours ($\beta$=0.9)'    
    plot_line(metrics, walltime, setting_labels, 'Training Time (hour)', plot_metric, 'time_to_acc_har_yogi_beta_walltime.pdf')
...
'logs/har/0818_180500_51471/aggregator/training_perf',
'logs/har/0816_174536_52223/aggregator/training_perf',
'logs/har/0818_180508_2769/aggregator/training_perf',
])
